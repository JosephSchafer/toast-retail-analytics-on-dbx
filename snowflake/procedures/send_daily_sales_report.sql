...
<h1>Three Sisters Provisions</h1>
...
<div class="ft">Generated by Snowflake &bull; Three Sisters Provisions Analytics<br>'' || CURRENT_TIMESTAMP()::VARCHAR || ''</div>
</div></body></html>'';
  
  CALL SYSTEM$SEND_SNOWFLAKE_NOTIFICATION(
    SNOWFLAKE.NOTIFICATION.TEXT_HTML(:v_html),
    SNOWFLAKE.NOTIFICATION.EMAIL_INTEGRATION_CONFIG(''TSP_EMAIL_REPORTS'', ''Three Sisters - Daily Sales Report'', ARRAY_CONSTRUCT(''joe@threesistersprovisions.com''))
  );
